...
// ***********************************************************************
// <copyright file="ZeroitLollipopComboBox.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.LollipopControls.Controls
{
    ...
    public class ZeroitLollipopComboBox : ComboBox, IMaterialControl
    {
        ...
        /// <summary>
        /// The drop down border color
        /// </summary>
        private Color dropDownBorderColor = Color.FromArgb(22, 22, 22);

        /// <summary>
        /// The drop down color
        /// </summary>
        private Color dropDownColor = Color.Yellow;
        ...
        /// The cards brush
        /// </summary>
        private Color cardsBrush = Color.Brown;

        /// <summary>
        /// The flat button hover
        /// </summary>
        private Color flatButtonHover = Color.Lime;
        ...
        /// </summary>
        /// <value>The color of the drop down border.</value>
        ...
        /// </summary>
        /// <value>The color of the drop down.</value>
        public Color DropDownColor { get => dropDownColor; set { dropDownColor = value; Invalidate(); } }

        /// <summary>
        /// Gets or sets the color of the arrow.
        /// </summary>
        /// <value>The color of the arrow.</value>
        public Color ArrowColor { get => arrowColor; set { arrowColor = value; Invalidate(); } }

        /// <summary>
        /// Gets or sets the cards brush.
        /// </summary>
        /// <value>The cards brush.</value>
        public Color CardsBrush { get => cardsBrush; set { cardsBrush = value; Invalidate(); } }

        /// <summary>
        /// Gets or sets the flat button hover.
        /// </summary>
        /// <value>The flat button hover.</value>
        public Color FlatButtonHover { get => flatButtonHover; set { flatButtonHover = value; Invalidate(); } }

        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitLollipopComboBox"/> class.
        /// </summary>
        public ZeroitLollipopComboBox()
        {
        ...
        public void DrawNativeBorder(IntPtr handle)
        {
            ...
            Color borderColor = dropDownBorderColor;
        ...
        {
            Pen objPen = new Pen(DroppedDown ? new SolidBrush(DropDownColor) : new SolidBrush(ArrowColor), 1);
            ...
            if (SelectedIndex >= 0) { 
            g.DrawString(Items[SelectedIndex].ToString(), Font, new SolidBrush(ForeColor), 0, 0);
            }
            ...
            g.FillPolygon(DroppedDown ? new SolidBrush(DropDownColor) : new SolidBrush(ArrowColor), objTriangle);
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            {
                e.Graphics.FillRectangle(new SolidBrush(FlatButtonHover), e.Bounds);
            }
            else
            {
                e.Graphics.FillRectangle(new SolidBrush(CardsBrush), e.Bounds);
            }
            ...
            e.Graphics.DrawString(Items[e.Index].ToString(), Font, new SolidBrush(ForeColor), new RectangleF(e.Bounds.X + rectangle.Width, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height));
